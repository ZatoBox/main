                    ...
                    <Field name="twoFactorEnabled">
                      {({ field }: any) => (
                        <input
                          {...field}
                          type="checkbox"
                          className="peer w-4 h-4 rounded border border-[#CBD5E1] bg-white
                            checked:bg-[#EEB131] checked:border-[#767676]
                            focus:outline-none  focus:ring-[#767676] appearance-none"
                        />
                      )}
                    </Field>
                    <span className="text-sm text-[#888888] peer-checked:text-[#000000]">
