      ...
      <div className='pt-6 border-t border-divider'>
        ...
        <div className='space-y-3'>
          {sessions.map((session) => (
            <div
              key={session.id}
              className='flex items-center justify-between p-4 border rounded-lg bg-gray-50 border-divider'
            >
                  ...
                  <input
                    ...
                    checked={
                      profileData.notifications[
                        key as keyof typeof profileData.notifications
                      ].email
                    }
                    onChange={(e) =>
        ...
        <div className='flex items-center justify-between'>
          <div>
            ...
            <div className='text-text-secondary'>
              $29.99/month • Up to 10,000 products
            </div>
          </div>
      ...
      <div>
        ...
        {paymentCards.length > 0 && (
          <div className='p-4 border rounded-lg bg-gray-50 border-divider'>
            <div className='flex items-center space-x-3'>
              {getCardIcon(
                paymentCards.find((card) => card.isDefault)?.type || 'visa'
              )}
              <div>
                <div className='font-medium text-text-primary'>
                  •••• •••• ••••{' '}
                ...
                <div className='text-sm text-text-secondary'>
                  {(() => {
                    const defaultCard = paymentCards.find(
                      (card) => card.isDefault
                    );
                    if (!defaultCard) {
                    ...
                    return `${
                      defaultCard.type.charAt(0).toUpperCase() +
                      defaultCard.type.slice(1)
                    } • Expires ${defaultCard.expiryMonth}/${
              ...
              {invoices.map((invoice) => (
                <tr key={invoice.id}>
                  ...
                  <td className='px-4 py-4'>
                    <span
                      className={`inline-flex px-2 py-1 text-xs font-medium rounded-full ${getInvoiceStatusColor(
                        invoice.status
                      )}`}
                    >
                      {invoice.status}
                ...
                >
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleNewCardChange('number', e.target.value)
                      }
                  ...
                  <div className='flex space-x-2'>
                    <div className='flex-1'>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleNewCardChange('expiryMonth', e.target.value)
                        }
                        className='w-full p-2 border rounded border-divider'
                        maxLength={2}
                        required
                    ...
                    <div className='flex-1'>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleNewCardChange('expiryYear', e.target.value)
                        }
                        className='w-full p-2 border rounded border-divider'
                        maxLength={4}
                        required
                    ...
                    <div className='flex-1'>
                      ...
                      <input
                        ...
                        value={newCard.cvc}
                        onChange={(e) =>
                          handleNewCardChange('cvc', e.target.value)
                        }
                        className='w-full p-2 border rounded border-divider'
                        maxLength={4}
                        required
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleNewCardChange('holderName', e.target.value)
                      }
                      className='w-full p-2 border rounded border-divider'
                      required
                    />
                ...
                <>
                  ...
                  <div className='space-y-3'>
                    {paymentCards.map((card) => (
                      <div
                        key={card.id}
                        className='flex items-center justify-between p-3 border rounded border-divider'
                      >
                        <div>
                          <span className='mr-2'>{getCardIcon(card.type)}</span>
                          <span>•••• {card.lastFour}</span>
                          <span className='ml-2 text-xs text-text-secondary'>
                            {card.type.toUpperCase()} • {card.expiryMonth}/
                            {card.expiryYear}
                          </span>
                          {card.isDefault && (
                            <span className='px-2 py-1 ml-2 text-xs rounded bg-success-100 text-success-800'>
                              Default
                            </span>
                          )}
                        </div>
