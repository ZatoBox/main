        ...
        <div className="w-full max-w-md p-6 border rounded-lg shadow-sm bg-bg-surface border-divider">
          ...
          <div>
            <img
              src={logo}
              alt="Logo"
              className="block ml-0 mr-auto w-[160px] h-[52px] object-contain"
            />
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute transition-colors transform -translate-y-1/2 right-3 top-1/2 text-[#E28E18] hover:text-[#c97a13]"
              >
                {showPassword ? (
                  <EyeOff size={20} className="text-[#E28E18]" />
                ) : (
                  <Eye size={20} className="text-[#E28E18]" />
                )}
              </button>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              >
                ...
                <button
                  type="button"
                  className="font-medium transition-colors text-[#E28E18] hover:text-[#c97a13]"
                >
                  Terms and Conditions
                </button>{" "}
                and{" "}
