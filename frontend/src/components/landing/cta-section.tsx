    ...
    <section className='w-full pt-20 md:pt-60 lg:pt-60 pb-10 md:pb-20 px-5 relative flex flex-col justify-center items-center overflow-visible'>
      ...
      <div className='relative z-10 flex flex-col justify-start items-center gap-9 max-w-4xl mx-auto'>
        <div className='flex flex-col justify-start items-center gap-4 text-center'>
          <h2 className='text-zatobox-900 text-4xl md:text-5xl lg:text-[68px] font-semibold leading-tight md:leading-tight lg:leading-[76px] break-words max-w-[600px] text-center mx-0'>
            {getTranslation(language, 'cta.title')}
          </h2>
          <p className='text-zatobox-600 text-sm md:text-base font-medium leading-[18.20px] md:leading-relaxed break-words max-w-2xl'>
        ...
        >
          <Button
            className='px-[30px] py-2 bg-zatobox-500 text-white text-base font-medium leading-6 rounded-[99px] shadow-[0px_0px_0px_4px_rgba(255,255,255,0.13)] hover:opacity-90 transition-all duration-200'
            size='lg'
          >
